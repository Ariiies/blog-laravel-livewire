<x-layouts.admin>
    <flux:breadcrumbs  class="mb-4">
            ...
            <flux:breadcrumbs.item href="{{route('permissions.index')}}" libewire:navigate>Permissions</flux:breadcrumbs.item> 
        ...
        <form action="{{ route('permissions.store') }}" method="POST" class="space-y-4">
            ...
            <a href="{{ route('permissions.index') }}" class="bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400 ml-2">Cancelar</a>
        </form>
</x-layouts.admin>