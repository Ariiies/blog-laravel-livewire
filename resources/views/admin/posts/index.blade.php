            ...
            <tbody>
                ...
                @foreach ($posts as $post)
                    <tr class="{{ $loop->even ? 'bg-blue-100 dark:bg-gray-700' : 'bg-white dark:bg-gray-800' }} border-b border-gray-200 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('posts.show', $post->id) }}" class="text-blue-700 dark:text-blue-300 font-semibold hover:underline">
                                {{ $post->title }}
                            </a>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('posts.edit', $post->id) }}" class="text-blue-600 hover:text-blue-900 font-semibold">Edit</a>
                        </td>
                        <td class="px-6 py-4">
